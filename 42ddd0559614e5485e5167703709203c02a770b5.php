  ...
  <div align="center">
    <div class="card" style="width: 18rem; display: inline-block; margin-top: 20px; margin-left: 3%;">
      ...
      <div class="card-body" align="justify">
        ...
        <br>
        <div align="center">
        <a class="nav-link text-light " href="<?php echo e(url('about-us')); ?>">
    ...
    <div class="card" style="width: 18rem; display: inline-block;margin-top: 20px; margin-left: 3%;">
      ...
      <div class="card-body" align="justify">
        ...
        <br>
        <div align="center">
        <a class="nav-link text-light " href="<?php echo e(url('contact-us')); ?>">
          <button type="button" class="btn btn-success">Ver >></button>
        </a>
        </div>
      </div>
...
</html><?php /**PATH C:\Users\avico\OneDrive\Escritorio\EcoPeru\resources\views/home.blade.php ENDPATH**/ ?>